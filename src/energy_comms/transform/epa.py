...
def transform(df):
    ...
    zip_code_crosswalk = pd.read_excel('/Users/mcastillo/Documents/GitHub/rmi-energy-communities/src/energy_comms/extract/ZIP_COUNTY_122021.xlsx',dtype={'zip':str,'county':str})
