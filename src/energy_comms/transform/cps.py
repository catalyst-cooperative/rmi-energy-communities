...
def transform(x):
    ...
    annual_average = annual_average.append(
        {"year": 2019, "value": 3.7}, ignore_index=True
    )
    annual_average = annual_average.append(
        {"year": 2020, "value": 8.1}, ignore_index=True
    )
    ...
    annual_average = annual_average.rename(
        columns={"value": "national_unemployment_rate_prev_year"}
    )
